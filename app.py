...
def generate(page_name):
    ...
    with open(md_file_path, 'r', encoding='utf-8') as f:
        md_text = f.read()
    html = markdown.markdown(md_text, output_format='html5', extensions=['fenced_code', 'tables', 'pymdownx.inlinehilite', 'pymdownx.highlight', 'pymdownx.superfences', 'codehilite'])
